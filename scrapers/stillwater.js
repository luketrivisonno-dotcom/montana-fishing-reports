...
async function scrapeStillwater() {
  const url = 'https://www.orvis.com/fishing-report/stillwater-river';
  ...
  try {
    ...
    console.error('Stillwater River error:', error.message);
    return null;
  }
}

module.exports = scrapeStillwater;
