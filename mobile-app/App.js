...
import { 
  ...
  SafeAreaView, StatusBar, ImageBackground, ScrollView, Dimensions, Alert
} from 'react-native';
...
function HomeScreen({ navigation }) {
  ...
  const getRiverSubtitle = (river) => {
    ...
    if (river.includes('Lower Madison')) return 'Beartrap Canyon to Threeforks';
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        {/* USGS Data Card with Location Label */}
        {data?.usgs && (
          <TouchableOpacity 
